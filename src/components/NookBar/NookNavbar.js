...
function NookNavbar() {
  ...
  return (
    <div className="max-m-[5%] min-w-[8%] bg-[#FFAC75] min-h-screen flex flex-col items-center pb-4">
        <div className="w-full p-2">
          <div className="bg-[#FDCBA9] rounded-full aspect-square w-full flex items-center justify-center">
            <Image
              priority
              src={NookLogo}
              alt="Nook Logo"
